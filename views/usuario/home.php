...
<div class="row">
    ...
    <div class="col-sm-6 ">
        ...
        <div class="panel panel-<?php echo ($modulo_liberado >= 0.7) ? "info" : "default mod_desabilitado"?>">
            ...
            <div class="panel-footer">
                ...
                <div class="row">
                    ...
                    <button type="button" <?php echo ($modulo_liberado <= 0.7) ? "disabled" : "" ?> class="btn btn-default col-sm-7" onclick="location.href = '?controller=categoria&action=lista&modulo=<?php echo $modulo->getId(); ?>'">
                        <span class="glyphicon glyphicon-play"></span> Praticar</button>


                    <button type="button" <?php echo ($modulo_liberado <= 0.7) ? "disabled" : "" ?> class="btn btn-default  col-sm-4 col-md-offset-1" onclick="location.href = '?controller=atividade&action=lista&modulo=<?php echo $modulo->getId(); ?>'">
