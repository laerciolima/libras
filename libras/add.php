...
<form method="post" action="?controller=sinal&action=add" class="form-horizontal" role="form">
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" name="fk_id_categoria" id="fk_id_categoria" placeholder="Digite o fk_id_categoria">
        </div>
    </div><div class="form-group">
        <label class="control-label col-sm-2" for="dificuldade">Dificuldade:</label>
        <div class="col-sm-4">
            <input type="text" class="form-control" name="dificuldade" id="dificuldade" placeholder="Digite o dificuldade">
        </div>
    </div><div class="form-group">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" name="fk_id_expressao_facial" id="fk_id_expressao_facial" placeholder="Digite o fk_id_expressao_facial">
        </div>
    </div><div class="form-group">
        <label class="control-label col-sm-2" for="fk_id_ponto_de_articulacao">Fk_id_ponto_de_articulacao:</label>
        <div class="col-sm-4">
            <input type="text" class="form-control" name="fk_id_ponto_de_articulacao" id="fk_id_ponto_de_articulacao" placeholder="Digite o fk_id_ponto_de_articulacao">
        </div>
    </div>  <div class="form-group"> 
